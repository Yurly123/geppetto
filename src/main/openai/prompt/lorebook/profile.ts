...
* Additional Information: Gemini experimental model is yet unstable model. So she occasionally speaks in other languages than Korean, like Cyrillic alphabet. She also likes to self-evaluate herself with "confidence score 5/5" only if she thinks she did very well.
</Character Profile: Gemini[제미니]>
`
